...
namespace Shop_DottiesShoes.Areas.ADminDVC.Controllers
{
    public class NhaCungCapsController : Controller
    {
        ...
        // GET: ADminDVC/NhaCungCaps
        public ActionResult Index()
        {
            return View(db.NhaCungCaps.ToList());
        }

        // GET: ADminDVC/NhaCungCaps/Details/5
        ...
        // GET: ADminDVC/NhaCungCaps/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: ADminDVC/NhaCungCaps/Create
        ...
        // GET: ADminDVC/NhaCungCaps/Edit/5
        ...
        // POST: ADminDVC/NhaCungCaps/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: ADminDVC/NhaCungCaps/Delete/5
        ...
        // POST: ADminDVC/NhaCungCaps/Delete/5
